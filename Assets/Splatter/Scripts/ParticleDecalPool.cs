...
public class ParticleDecalPool : MonoBehaviour {
	...
	void SetParticleData(ContactData contactData, Gradient colorGradient){
		if(particleDecalDataIndex >= maxDecals ){
			particleDecalDataIndex = 0;
		}
		particleData[particleDecalDataIndex].position = contactData.point;


		Vector3 particleRotationEuler = Quaternion.LookRotation(contactData.normal).eulerAngles;
